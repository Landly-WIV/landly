"""
searchFunctions.py - Frontend Such-Logik
==========================================
Enthält den SearchState, UI-Callbacks für die Suche und
API-Aufrufe zum Laden von Labels.

Ersetzt: backend/searchFunctions.py (der Frontend-Teil davon)
"""
...
def getLab():
    """Labels aus der Backend-API laden."""
    global _lab
    if _lab is None:
        try:
            res = httpx.get(f"{API_URL}/labels")
...
class searchState():
    def __init__(self):
        ...
        self.selectedProduct = None  # Ausgewähltes Produkt für Detailansicht
